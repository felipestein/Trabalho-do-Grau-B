...
public:
    ...
    void update(Shader& shader)
    {
        ...
        model = glm::rotate(model, getRotation().x, glm::vec3(1.0, 0.0, 0.0));
        model = glm::rotate(model, getRotation().y, glm::vec3(0.0, 1.0, 0.0));
        model = glm::rotate(model, getRotation().z, glm::vec3(0.0, 0.0, 1.0));
